...
const uploadBtn = document.getElementById("uploadBtn") as HTMLButtonElement; // Upload Button
const fileInput = document.getElementById("fileInput") as HTMLInputElement; // File input field
const resultsF = document.getElementById("results") as HTMLPreElement; // Results area (preformatted text block)

// Add a click event listener to the Upload button
uploadBtn.addEventListener("click", async (e: MouseEvent) => {
